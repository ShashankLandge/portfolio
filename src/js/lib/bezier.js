import { BEZIER } from "./constants.js";

function clampPointToCanvas(point, canvasWidth, canvasHeight) {
...
export function generateBezierPath(startPoint, canvasWidth, canvasHeight) {
  const radius =
